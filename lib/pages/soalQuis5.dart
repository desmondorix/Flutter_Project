                            ...
                            5,
                              ...
                              onTap: () {
                                ...
                                if (index == 3) {
                                  ...
                                  Navigator.pop(
                                    context,
                                    MaterialPageRoute(builder: (context) => soal4()),
                                  );
                                }
                                if (index == 0) {
                                  // Navigate to another page when the user clicks on the circle with the number 2
                              ...
                              child: Container(
                                ...
                                decoration: BoxDecoration(
                                  ...
                                  color: index == 4 ? Color(0xFFB64D3A) : Colors.white,
                                  border: Border.all(
